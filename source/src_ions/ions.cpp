...
void Ions::opt_ions_pw(ModuleESolver::ESolver *p_esolver)
{
    ...
    //----------------------------------------------------------	
		...
		int eiter=0;		
        if (GlobalV::CALCULATION=="scf" || GlobalV::CALCULATION=="ofdft" || GlobalV::CALCULATION=="md" || GlobalV::CALCULATION=="relax" || GlobalV::CALCULATION=="cell-relax")  // pengfei 2014-10-13
        {
#ifdef __LCAO
#ifdef __MPI
